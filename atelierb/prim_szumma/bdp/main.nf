...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(main))==(main_op);
  List_Operations(Machine(main))==(main_op)
END
&
THEORY ListInputX IS
  List_Input(Machine(main),main_op)==(?)
END
&
THEORY ListOutputX IS
  List_Output(Machine(main),main_op)==(?)
END
&
THEORY ListHeaderX IS
  List_Header(Machine(main),main_op)==(main_op)
END
&
THEORY ListOperationGuardX END
&
THEORY ListPreconditionX IS
  List_Precondition(Machine(main),main_op)==(btrue)
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(main),main_op)==(btrue | skip);
  List_Substitution(Machine(main),main_op)==(skip)
END
&
...
THEORY ListANYVarX IS
  List_ANY_Var(Machine(main),main_op)==(?);
  List_ANY_Var(Machine(main),?)==(?)
END
&
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(main)) == (? | ? | ? | ? | main_op | ? | ? | ? | main);
...
THEORY OperationsEnvX IS
  Operations(Machine(main)) == (Type(main_op) == Cst(No_type,No_type));
  Observers(Machine(main)) == (Type(main_op) == Cst(No_type,No_type))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
