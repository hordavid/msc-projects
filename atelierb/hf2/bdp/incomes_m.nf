...
THEORY ListPreconditionX IS
  List_Precondition(Machine(incomes_m),get_income)==(day: dom(incomes) & income: 0..100000 & incomes(day): 0..1000000);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(incomes_m),get_income)==(day: dom(incomes) & income: 0..100000 & incomes(day): 0..1000000 | income:=incomes(day));
